...
export function HomePageClient({ 
  ...
  // Define a categoria principal inicial e o estado do acordeão
  useEffect(() => {
    if (initialMainCategories.length > 0) {
      setSelectedMainCategory(initialMainCategories[0] || 'Todos');
    }
  }, [initialMainCategories]);
    ...
    if (!initialQuotes.length) {
      return (
        <div className="text-center py-16">
          <p className="text-muted-foreground">Carregando frases ou nenhuma frase encontrada...</p>
        </div>
      )
    }
