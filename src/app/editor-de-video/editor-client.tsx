...
function EditorCore() {
  ...
  const handleSetActiveControl = (control: string) => {
  ...
  }, [isDesktop, currentState.aspectRatio, activeControl]);
  ...
  const commonProps = {
    ...
    textColor: currentState.textColor, setTextColor: (val: string) => updateState({ textColor: val }),
