...
const defaultTemplatesData: Template[] = [
  { id: 'template-default', name: "Modelo Padrão", editorState: { fontSize: 2.7, showProfileSignature: true, signatureScale: 63, signaturePositionY: 90, aspectRatio: "9 / 16", activeTemplateId: 'template-default' }, isCustom: false, thumbnail: null },
